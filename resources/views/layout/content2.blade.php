...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/headerpreview.css') }}">
                    ...
                    <nav class="navbar navbar-expand display">
                        <div id="sidebar" style="text-align: left;">
                            <ul class="navbar-nav prev-next-list">
                                ...
                                <li class="nav-item"><a href="/riwayatpendidikan" class="nav-link next-button">Riwayat Pendidikan</a></li>
                                <li class="nav-item"><a href="/riwayatpekerjaan" class="nav-link next-button">Riwayat Pekerjaan</a></li>
                                <li class="nav-item"><a href="/keterampilan" class="nav-link next-button">Keterampilan</a></li>
                                <li class="nav-item"><a href="/dokumenpendukung" class="nav-link next-button">Dokumen Pendukung</a></li>
