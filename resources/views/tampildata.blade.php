...
<nav class="navbar navbar-expand-md navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('home') }}">
            <img src="image/Logo2.png" width="70" height="70">
        </a>
    </div>
</nav>
<h1 class="center">EDIT DATA</h1>
<div class="container">
                    ...
                    <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                        ...
                        <div class="fn-ln">   
                          <div class="mb-3">
                              ...
                              aria-describedby="emailHelp" value = "{{ $data -> firstName }}">
                          </div>
                          <div class="mb-3">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-md-6">
                              <div class="mb-3">
                                  ...
                                  <input type="number" name="nomorTelepon" class="form-control" id="nomorTelepon" value = "{{ $data -> nomorTelepon }}">
                              </div>
                          </div>
                          <div class="col-md-6">
                              <div class="mb-3">
                                  <label for="emailUser" class="form-label">Email*</label>
                                  <input type="email" name="emailUser" class="form-control" id="emailUser" value = "{{ $data -> emailUser }}">
                              </div>
                          </div>
                        </div>                      
                        ...
                        <div class="justify-content-center">
                              ...
                              <div class="row mb-3">
                                  ...
                                  <div class="col-4 custom-col">
                                      ...
                                      <select class="form-select" name="country" aria-label="Default select example" value = "{{ $data -> country }}">
