                ...
                <div class="card-body">
                  <form action="/insertdatapekerjaan" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                    ...
                    <div style="display: flex; align-items: center;">
                        <img src="image/network-enterprise_.png" alt="Profil Image" style="margin-right: 15px; width: 30px;">
                    ...
                    <div class="mb-3">
                      ...
                      <table class="table">
                          ...
                          <tbody id = "Pekerjaan">
                              <tr>
                                  <td><input type="text" class="form-control" name="riwayatPekerjaan[0][pekerjaan]" placeholder="Posisi kerja" style="width:200px" required></td>
                                  <td><input type="text" class="form-control" name="riwayatPekerjaan[0][employer]" placeholder="Perusahaan" style="width:250px" required></td>
                                  <td><input type="text" class="form-control" name="riwayatPekerjaan[0][city]" placeholder="mis. Bandung" required></td>
                                  <td><input type="date" class="form-control" name="riwayatPekerjaan[0][mulaikerja]" style="width:130px;" required></td>
                                  <td><input type="date" class="form-control" name="riwayatPekerjaan[0][akhirkerja]" style="width:130px;" required></td>
                              </tr>
                          </tbody>
                      </table>
                  </div>
