                ...
                <div class="container mb-1">
                  <div class="row-1" id="Pekerjaan">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="riwayatPekerjaan[0][pekerjaan]" class="form-control" id="pekerjaan"
                        aria-describedby="emailHelp">
                    </div>

                    <div class="mb-3">
                      <label for="city" class="form-label">City*</label>
                      <input type="text" name="riwayatPekerjaan[0][city]" class="form-control" id="city"
                        aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Employer*</label>
                      <input type="text" name="riwayatPekerjaan[0][employer]" class="form-control" id="employer"
                        aria-describedby="emailHelp">
                    </div>
                    ...
                    <div class="justify-content-center">
                      <div class="row mb-3">
                        ...
                        <div class="col-3">
                          ...
                          <select class="form-select" name="riwayatPekerjaan[0][mulai]" id="mulai"
                        ...
                        <div class="col-3">
                          ...
                          <select class="form-select" name="riwayatPekerjaan[0][tahun]" id="tahun"
                            aria-label="Default select example">
                            <option value="" disabled selected></option>
                        ...
                        <div class="col-3">
                          ...
                          <select class="form-select" name="riwayatPekerjaan[0][terakhir]" id="terakhir"
                            aria-label="Default select example">
                            <option value="" disabled selected></option>
                            <option value="January">January</option>
                            <option value="February">February</option>
                        ...
                        <div class="col-3">
                          ...
                          <select class="form-select" name="riwayatPekerjaan[0][tambah]" id="tambah"
                            aria-label="Default select example">
                            <option value="" disabled selected></option>
                            <option value="1960">1961</option>
                            <option value="1962">1962</option>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="riwayatPekerjaan[0][deskripsis]" class="form-control" id="deskripsis"
                      aria-describedby="emailHelp">
                  </div>
                  <button type="button" class="btn btn-secondary" id="tambahRiwayatPekerjaan">Tambah Riwayat
                    Pekerjaan</button>
